...
dataset = dict(
    ...
    root = root,
    data_path= "datasets/csp_817_data_cut/features",
    stocks_path = "datasets/csp_817_data_cut/stocks_cut.txt",
    aux_stocks_path = "datasets/csp_817_data_cut/aux_stocks_files_cleaned",
